...
@JsonSubTypes(
    JsonSubTypes.Type(
        value = RevoltWebSocketRequest.Authenticate::class,
        name = "Authenticate"
    ),
    JsonSubTypes.Type(
        value = RevoltWebSocketRequest.BeginTyping::class,
        name = "BeginTyping"
    ),
    JsonSubTypes.Type(
        value = RevoltWebSocketRequest.EndTyping::class,
        name = "EndTyping"
    ),
    JsonSubTypes.Type(
        value = RevoltWebSocketRequest.Ping::class,
        name = "Ping"
    ),
)
@Keep
...
@JsonSubTypes(
    JsonSubTypes.Type(
        value = RevoltWebSocketResponse.Error::class,
        name = "Error"
    ),
    JsonSubTypes.Type(
        value = RevoltWebSocketResponse.Authenticated::class,
        name = "Authenticated"
    ),
    JsonSubTypes.Type(
        value = RevoltWebSocketResponse.Bulk::class,
        name = "Bulk"
    ),
    JsonSubTypes.Type(
        value = RevoltWebSocketResponse.Pong::class,
        name = "Pong"
    ),
    JsonSubTypes.Type(
        value = RevoltWebSocketResponse.Ready::class,
        name = "Ready"
    ),
    JsonSubTypes.Type(
        value = RevoltWebSocketResponse.Message::class,
        name = "Message"
    ),
    JsonSubTypes.Type(
        value = RevoltWebSocketResponse.MessageUpdate::class,
        name = "MessageUpdate"
    ),
    JsonSubTypes.Type(
        value = RevoltWebSocketResponse.MessageAppend::class,
        name = "MessageAppend"
    ),
    JsonSubTypes.Type(
        value = RevoltWebSocketResponse.MessageDelete::class,
        name = "MessageDelete"
    ),
    JsonSubTypes.Type(
        value = RevoltWebSocketResponse.MessageReact::class,
        name = "MessageReact"
    ),
    JsonSubTypes.Type(
        value = RevoltWebSocketResponse.MessageUnreact::class,
        name = "MessageUnreact"
    ),
    JsonSubTypes.Type(
        value = RevoltWebSocketResponse.MessageRemoveReaction::class,
        name = "MessageRemoveReaction"
    ),
    JsonSubTypes.Type(
        value = RevoltWebSocketResponse.ChannelCreate::class,
        name = "ChannelCreate"
    ),
    JsonSubTypes.Type(
        value = RevoltWebSocketResponse.ChannelUpdate::class,
        name = "ChannelUpdate"
    ),
    JsonSubTypes.Type(
        value = RevoltWebSocketResponse.ChannelDelete::class,
        name = "ChannelDelete"
    ),
    JsonSubTypes.Type(
        value = RevoltWebSocketResponse.ChannelGroupJoin::class,
        name = "ChannelGroupJoin"
    ),
    JsonSubTypes.Type(
        value = RevoltWebSocketResponse.ChannelGroupLeave::class,
        name = "ChannelGroupLeave"
    ),
    JsonSubTypes.Type(
        value = RevoltWebSocketResponse.ChannelStartTyping::class,
        name = "ChannelStartTyping"
    ),
    JsonSubTypes.Type(
        value = RevoltWebSocketResponse.ChannelStopTyping::class,
        name = "ChannelStopTyping"
    ),
    JsonSubTypes.Type(
        value = RevoltWebSocketResponse.ChannelAcknowledge::class,
        name = "ChannelAck"
    ),
    JsonSubTypes.Type(
        value = RevoltWebSocketResponse.ServerCreate::class,
        name = "ServerCreate"
    ),
    JsonSubTypes.Type(
        value = RevoltWebSocketResponse.ServerUpdate::class,
        name = "ServerUpdate"
    ),
    JsonSubTypes.Type(
        value = RevoltWebSocketResponse.ServerDelete::class,
        name = "ServerDelete"
    ),
    JsonSubTypes.Type(
        value = RevoltWebSocketResponse.ServerMemberUpdate::class,
        name = "ServerMemberUpdate"
    ),
    JsonSubTypes.Type(
        value = RevoltWebSocketResponse.ServerMemberJoin::class,
        name = "ServerMemberJoin"
    ),
    JsonSubTypes.Type(
        value = RevoltWebSocketResponse.ServerMemberLeave::class,
        name = "ServerMemberLeave"
    ),
    JsonSubTypes.Type(
        value = RevoltWebSocketResponse.ServerRoleUpdate::class,
        name = "ServerRoleUpdate"
    ),
    JsonSubTypes.Type(
        value = RevoltWebSocketResponse.ServerRoleDelete::class,
        name = "ServerRoleDelete"
    ),
    JsonSubTypes.Type(
        value = RevoltWebSocketResponse.UserUpdate::class,
        name = "UserUpdate"
    ),
    JsonSubTypes.Type(
        value = RevoltWebSocketResponse.UserRelationship::class,
        name = "UserRelationship"
    ),
    JsonSubTypes.Type(
        value = RevoltWebSocketResponse.UserPlatformWipe::class,
        name = "UserPlatformWipe"
    ),
    JsonSubTypes.Type(
        value = RevoltWebSocketResponse.EmojiCreate::class,
        name = "EmojiCreate"
    ),
    JsonSubTypes.Type(
        value = RevoltWebSocketResponse.EmojiDelete::class,
        name = "EmojiDelete"
    ),
    JsonSubTypes.Type(
        value = RevoltWebSocketResponse.Auth::class,
        name = "Auth"
    ),
)
...
sealed class RevoltWebSocketResponse constructor() {
    ...
    data class UserUpdate(
        ...
        @param:JsonProperty("data") val data: RevoltUserUpdate,
        @param:JsonProperty("clear") val clear: List<String>,
    ) : RevoltWebSocketResponse()
