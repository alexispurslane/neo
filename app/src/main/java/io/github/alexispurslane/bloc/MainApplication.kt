...
const val SERVER_CHANNEL_ID: String =
    "io.github.alexispurslane.bloc.ServerNotifications"
const val SERVICE_CHANNEL_ID: String =
    "io.github.alexispurslane.bloc.BackgroundProcesses"
const val PACKAGE_NAME: String = "io.github.alexispurslane.bloc"
...
class MainApplication : Application() {
    ...
    override fun onCreate() {
        ...
        createNotificationChannel(
            ...
            "This channel shows you what background processes (such as services listening for notifications from the Revolt server) Bloc is running."
        )
    }
