...
import io.github.alexispurslane.neo.ui.composables.misc.UserCard
import io.github.alexispurslane.neo.viewmodels.UserProfileViewModel
        ...
        Column(
            ...
            Column(
                ...
                if (uiState.isMyProfile) {
                    ...
                    SettingsRow(
                        title = "RTL Navigation Drawer Orientation",
                        comment = "Whether the navigation drawer opens right-to-left or the reverse."
                    ) {
                        Switch(checked = uiState.preferences["isNavDrawerOrientationRtl"]?.toBooleanStrictOrNull() ?: true, onCheckedChange = {
                            userProfileViewModel.setPreference("isNavDrawerOrientationRtl", it)
                        })
                    }
                    ...
                    SettingsRow(
                        ...
                        comment = "Instead of using Google's servers to read your notifications, Neo uses a background service."
                    ) {
