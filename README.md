...
Neo is newer, faster, and more featureful Android-native client for the [Matrix](https://matrix.org/) decentralized chat protocol, designed for Discord fugitives.
...
- [X] Reply, delete, and edit (sending)
